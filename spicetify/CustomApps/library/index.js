var library = (() => {
  ...
  // postcss-module:C:\Users\user\AppData\Local\Temp\tmp-13892-kKJrsymnD2fT\18eadb331c44\navBar.module.css
  ...
  var AddMenu = ({ collection }) => {
    ...
    const createCollection = () => {
      ...
      Spicetify.PopupModal.display({
        ...
        content: /* @__PURE__ */ import_react18.default.createElement(text_input_dialog_default, {
          def: "New Collection",
    ...
    return /* @__PURE__ */ import_react18.default.createElement(Menu, null, /* @__PURE__ */ import_react18.default.createElement(MenuItem2, {
      onClick: createCollection,
      leadingIcon: /* @__PURE__ */ import_react18.default.createElement(leading_icon_default, {
        path: SVGIcons["playlist-folder"]
      })
    }, "Create Collection"), /* @__PURE__ */ import_react18.default.createElement(MenuItem2, {
      onClick: addAlbum,
      leadingIcon: /* @__PURE__ */ import_react18.default.createElement(leading_icon_default, {
        path: SVGIcons["album"]
      })
  ...
  var AlbumsPage = ({ configWrapper, collection }) => {
    ...
    const [textFilter, setTextFilter] = import_react18.default.useState("");
    ...
    const props = {
      ...
      headerEls: [
        /* @__PURE__ */ import_react18.default.createElement(add_button_default, {
          Menu: /* @__PURE__ */ import_react18.default.createElement(AddMenu, {
            collection
          })
        }),
        dropdown,
        /* @__PURE__ */ import_react18.default.createElement(searchbar_default, {
    ...
    if (status === "pending") {
      return /* @__PURE__ */ import_react18.default.createElement(page_container_default, {
        ...props
      }, /* @__PURE__ */ import_react18.default.createElement(status_default, {
        icon: "library",
        heading: "Loading",
    ...
    const rootlistCards = rootlistItems.map((item) => {
      ...
      return /* @__PURE__ */ import_react18.default.createElement(spotify_card_default, {
        type: item.type,
        uri: item.uri,
        header: item.name,
    ...
    if (hasNextPage)
      rootlistCards.push(/* @__PURE__ */ import_react18.default.createElement(load_more_card_default, {
  ...
  var ArtistsPage = ({ configWrapper }) => {
    ...
    const props = {
      ...
      headerEls: [
        /* @__PURE__ */ import_react19.default.createElement(add_button_default, {
          Menu: /* @__PURE__ */ import_react19.default.createElement(AddMenu2, null)
        }),
        dropdown,
    ...
    if (hasNextPage)
      artistCards.push(/* @__PURE__ */ import_react19.default.createElement(load_more_card_default, {
        callback: fetchNextPage
      }));
    return /* @__PURE__ */ import_react19.default.createElement(page_container_default, {
      ...props
  ...
  var ShowsPage = ({ configWrapper }) => {
    ...
    const props = {
      ...
      headerEls: [
        /* @__PURE__ */ import_react20.default.createElement(add_button_default, {
          Menu: /* @__PURE__ */ import_react20.default.createElement(AddMenu3, null)
        }),
        dropdown,
    ...
    if (hasNextPage)
      showCards.push(/* @__PURE__ */ import_react20.default.createElement(load_more_card_default, {
        callback: fetchNextPage
      }));
    return /* @__PURE__ */ import_react20.default.createElement(page_container_default, {
      ...props
  ...
  var AddMenu4 = ({ folder }) => {
    ...
    }, "Create Folder"), /* @__PURE__ */ import_react21.default.createElement(MenuItem2, {
  ...
  var PlaylistsPage = ({ folder, configWrapper }) => {
    ...
    const [images, setImages] = import_react21.default.useState({ ...SpicetifyLibrary.FolderImageWrapper.getFolderImages() });
    const { useInfiniteQuery } = Spicetify.ReactQuery;
    const limit = 200;
    const fetchRootlist = async ({ pageParam }) => {
    ...
    const props = {
      ...
      headerEls: [
        /* @__PURE__ */ import_react21.default.createElement(add_button_default, {
          Menu: /* @__PURE__ */ import_react21.default.createElement(AddMenu4, {
            folder
          })
        }),
        sortDropdown,
    ...
    if (hasNextPage)
      rootlistCards.push(/* @__PURE__ */ import_react21.default.createElement(load_more_card_default, {
        callback: fetchNextPage
      }));
    return /* @__PURE__ */ import_react21.default.createElement(page_container_default, {
      ...props
  ...
  var NavbarContainer = ({ configWrapper }) => {
    const pages = {
      ["Artists"]: /* @__PURE__ */ import_react22.default.createElement(artists_default, {
        configWrapper
      }),
      ["Albums"]: /* @__PURE__ */ import_react22.default.createElement(albums_default, {
        configWrapper
      }),
      ["Shows"]: /* @__PURE__ */ import_react22.default.createElement(shows_default, {
        configWrapper
      }),
      ["Playlists"]: /* @__PURE__ */ import_react22.default.createElement(playlists_default, {
        configWrapper
      })
    };
    const [navBar, activeLink, setActiveLink] = useNavigationBar_default(tabPages);
    const [firstUpdate, setFirstUpdate] = import_react22.default.useState(true);
    const [newUpdate, setNewUpdate] = import_react22.default.useState(false);
    ...
    return /* @__PURE__ */ import_react22.default.createElement(import_react22.default.Fragment, null, navBar, newUpdate && /* @__PURE__ */ import_react22.default.createElement("div", {
      className: "new-update"
    }, "New app update available! Visit", " ", /* @__PURE__ */ import_react22.default.createElement("a", {
      href: "https://github.com/harbassan/spicetify-apps/releases"
    }, "harbassan/spicetify-apps"), " to install."), pages[activeLink]);
  };
  var App = () => {
    const [config, setConfig] = import_react22.default.useState({ ...SpicetifyLibrary.ConfigWrapper.Config });
    const launchModal = () => {
    ...
    if (/^\/folder\/.+/.test(route)) {
      return /* @__PURE__ */ import_react22.default.createElement("div", {
        id: "library-app"
      }, /* @__PURE__ */ import_react22.default.createElement(playlists_default, {
    ...
    if (/^\/collection\/.+/.test(route)) {
      return /* @__PURE__ */ import_react22.default.createElement("div", {
        id: "library-app"
      }, /* @__PURE__ */ import_react22.default.createElement(albums_default, {
    ...
    return /* @__PURE__ */ import_react22.default.createElement("div", {
      id: "library-app"
    }, /* @__PURE__ */ import_react22.default.createElement(NavbarContainer, {
      configWrapper
    }));
  };
  var app_default = App;
  ...
  function render() {
    return /* @__PURE__ */ import_react23.default.createElement(app_default, null);
  }
