var stats = (() => {
  ...
  // postcss-module:C:\Users\user\AppData\Local\Temp\tmp-10192-dDB8O29x6Jkg\1913c4a784c3\navBar.module.css
  ...
  // ../library/src/extensions/collections_wrapper.ts
  ...
  var collections_wrapper_default = CollectionsWrapper.INSTANCE;
  ...
  var CollectionMenu = ({ id }) => {
    ...
    const deleteCollection = () => {
      collections_wrapper_default.deleteCollection(id);
    };
    const renameCollection = () => {
      const name = collections_wrapper_default.getCollection(id)?.name;
      const rename = (newName) => {
        collections_wrapper_default.renameCollection(id, newName);
      };
    ...
    const image = collections_wrapper_default.getCollection(id)?.image;
    const setCollectionImage = () => {
      const setImg = (imgUrl) => {
        collections_wrapper_default.setCollectionImage(id, imgUrl);
      };
      Spicetify.PopupModal.display({
    ...
    const removeImage = () => {
      collections_wrapper_default.removeCollectionImage(id);
    };
